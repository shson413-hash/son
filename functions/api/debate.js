...
- position의 의미: 주제나 제안에 대체로 찬성·수용·긍정하면 "긍정", 반대·우려·비판하면 "부정"이다. 비찬반형 질문도 발언의 전체 태도를 둘 중 더 가까운 쪽으로 분류한다.
- 토론답게 가능하면 한 라운드 안에 "긍정"과 "부정"이 모두 나오게 한다. 억지로 사실을 왜곡해서 균형을 맞추지는 않는다.
...
형식:
{
  ...
  "agents":[
    {"id":"p1","position":"긍정","stance":"2~5글자 입장","message":"짧은 한 문장"},
    {"id":"p2","position":"부정","stance":"2~5글자 입장","message":"짧은 한 문장"},
    {"id":"p3","position":"긍정 또는 부정","stance":"2~5글자 입장","message":"짧은 한 문장"},
    {"id":"p4","position":"긍정 또는 부정","stance":"2~5글자 입장","message":"짧은 한 문장"},
    {"id":"expert","position":"긍정 또는 부정","stance":"2~5글자 입장","message":"짧은 한 문장"}
  ],
